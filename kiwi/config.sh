...
case $kiwi_iname in
  *-raspberrypi|*armv6*)
    zypper ar -f http://download.opensuse.org/ports/armv6hl/tumbleweed/repo/oss/ openSUSE-Ports-Tumbleweed-repo-oss
    ;;
  *)
    ARCH=$(uname -m)
    case $ARCH in
      aarch64)
        zypper ar -f http://download.opensuse.org/ports/aarch64/tumbleweed/repo/oss/ openSUSE-Ports-Tumbleweed-repo-oss
        ;;
      x86_64)
        zypper ar -f http://download.opensuse.org/tumbleweed/repo/oss/ openSUSE-Ports-Tumbleweed-repo-oss
        ;;
      *)
        zypper ar -f http://download.opensuse.org/ports/armv7hl/tumbleweed/repo/oss/ openSUSE-Ports-Tumbleweed-repo-oss
        ;;
    esac
    ;;
  *)
...
case "$kiwi_iname" in
  *-raspberrypi3_aarch64)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/RaspberryPi3/standard/ Factory-Contrib-RPi3
    ;;
  *-raspberrypi3)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/RaspberryPi2/standard/ Factory-Contrib-RPi3
    ;;
  *-thunderx)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/ThunderX/standard/ Factory-Contrib-Thunder
    ;;
  *-seattle)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/Seattle/standard/ Factory-Contrib-Seattle
    ;;
  *-chromebook)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/Chromebook/standard/ Factory-Contrib-Chromebook
    ;;
  *-m400)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/m400/standard/ Factory-Contrib-m400
    ;;
  *-hip05d02)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/HIP05D02/standard/ Factory-Contrib-hip05d02
    ;;
  *-odroid*)
     zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/Odroid/standard Factory-Contrib-Odroid
     ;;
  *-hikey)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/96boards/standard/ Factory-Contrib-hikey
    ;;
  *-pine64)
    zypper ar -f http://download.opensuse.org/repositories/devel:/ARM:/Factory:/Contrib:/Pine64/standard/ Factory-Contrib-pine64
    ;;
esac
